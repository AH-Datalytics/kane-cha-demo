...
export const STRINGS: Record<Locale, StringsTree> = {
  en: {
    ...
    priority: {
      ...
      readingChartBody: "The 2015, 2019, and 2022 CHA cycles are back-loaded to support trend analysis at launch. Dashed amber marks the 2024 CHA release.",
    ...
    admin: {
      ...
      demoNoteBody: "In production, this workspace authenticates against KCHD’s identity provider (Microsoft 365 tenant). Row-level security limits each user to their specific upload scope. Twenty users total; five with upload permissions.",
      ...
      usersLede: "Roughly 20 KCHD staff use this workspace. Row-level security restricts each user to their specified scope.",
      nameCol: "Name",
      deptCol: "Department",
      roleCol: "Role",
    ...
    footer: {
      ...
      staff: "KCHD staff",
      demoVersion: "Kane Health Atlas · v1.0",
    },
  },
  ...
  es: {
    ...
    priority: {
      ...
      readingChartBody: "Los ciclos de CHA de 2015, 2019 y 2022 están cargados para permitir el análisis de tendencias desde el lanzamiento. El trazo ámbar marca el lanzamiento de CHA 2024.",
    ...
    admin: {
      ...
      demoNoteBody: "En producción, esta área se autentica contra el proveedor de identidad de KCHD (inquilino Microsoft 365). La seguridad a nivel de fila limita a cada usuario a su alcance específico de carga. Veinte usuarios en total; cinco con permisos de carga.",
      ...
      usersLede: "Aproximadamente 20 miembros del personal de KCHD usan esta área de trabajo. La seguridad a nivel de fila restringe a cada usuario a su alcance especificado.",
      nameCol: "Nombre",
    ...
    footer: {
      ...
      demoVersion: "Atlas de Salud de Kane · v1.0",
    },
  },
  ...
  pl: {
    ...
    priority: {
      ...
      readingChartBody: "Cykle CHA 2015, 2019 i 2022 są wczytane, aby umożliwić analizę trendów od startu. Przerywana bursztynowa oznacza publikację CHA 2024.",
      latestCycleLabel: "CHA 2024",
    ...
    admin: {
      ...
      demoNoteBody: "W produkcji ten obszar uwierzytelnia się względem dostawcy tożsamości KCHD (Microsoft 365). Bezpieczeństwo wierszowe ogranicza każdego użytkownika do jego zakresu przesyłania. Dwudziestu użytkowników; pięciu z uprawnieniami przesyłania.",
      ...
      usersLede: "Około 20 pracowników KCHD korzysta z tego obszaru roboczego. Bezpieczeństwo wierszowe ogranicza każdego użytkownika do jego określonego zakresu.",
    ...
    footer: {
      ...
      staff: "Personel KCHD",
      demoVersion: "Atlas Zdrowia Kane · v1.0",
    },
  },
};
